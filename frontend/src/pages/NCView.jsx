          ...
          <div className="flex flex-wrap items-center justify-between gap-2 text-sm">
            ...
            {hasRole(user, 'responsable') && (
              <div className="flex items-center gap-2">
                ...
                <button onClick={()=>{
                  setOpenEdit(o=>!o)
                  // prefill form with current values for edit
                  setForm({
                ...
                <button onClick={async ()=>{
                  try{
                    const payload = {
                      ...
                      // If estado changed use PATCH to change it as well; backend handles estado_accion + comentario
                ...
                >
                  ...
                  <div className="space-y-2">
                    {items.length === 0 ? (
                      ...
                      <ActionCard key={action.id} action={action} onRequestDelete={requestDeleteAction} />
                    ))}
                  </div>
                </div>
              )
