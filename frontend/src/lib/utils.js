// Utils
// It's solely purpose is to provide a placeholder thumbnail for images that are not available or not loaded yet. It generates an SVG image with a specified name or text, which can be used as a fallback thumbnail in the frontend application.
