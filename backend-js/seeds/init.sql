...
-- Crear tablas con sus claves foráneas integradas
...
-- Índices útiles (Estos no tiran error porque MySQL permite múltiples índices con el mismo nombre en diferentes tablas o los ignora si ya están)
